...
def _build_points_for_player(ctx: GameContext) -> dict:
    ...
    for point_id, point in raw_points.items():
        ...
        point_copy["report_interval_seconds"] = _effective_interval(base_interval, efficiency_bonus)
...
async def herb_points(
    ...
    response = HerbPointsResponse(
        ...
        reason_data={"efficiency_bonus_rate": _get_gather_efficiency_bonus(ctx)},
...
async def herb_report(
    ...
    settle_result = HerbGatherSystem.settle_once(point_id)
