...
from app.game.schemas.SpellSchema import EquipSpellRequest, UnequipSpellRequest, UpgradeSpellRequest, ChargeSpellRequest, SpellListResponse
...
async def get_spell_list(
    ...
    response_data = SpellListResponse(
        ...
        reason_data={},
        player_spells=ctx.spell_system.player_spells,
